...
const Outcomes = () => {
  return (
    <section className="flex-col gap-8 bg-gray-50 dark:bg-slate-950 h-screen flex items-center justify-center px-6 sm:px-12 md:px-20 lg:px-32">
      {/* Judul */}
      ...
      {/* Tujuan AP-02 */}
      <p className="text-gray-900 text-base sm:text-lg md:text-xl lg:text-2xl dark:text-white text-center sm:text-left max-w-4xl">
        <b>AP-02 :</b> Mempraktikkan menulis kode program kemudian menjalankan dengan bahasa prosedural/tekstual tertentu
      </p>

      {/* Evidence */}
      <p className="text-gray-900 text-base sm:text-lg md:text-xl lg:text-2xl dark:text-white max-w-4xl">
        <b>Evidence</b>
        <br />
        <b>AP-02 :</b>
