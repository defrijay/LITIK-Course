...
const Outcomes = () => {
  return (
    <section className="flex-col gap-12 bg-slate-950 h-screen flex items-center justify-center px-6 sm:px-12 md:px-20 lg:px-32">
      {/* Judul */}
      ...
      {/* Deskripsi */}
      <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-white text-justify max-w-4xl">
      ...
      <div className="space-x-4 sm:space-x-8 md:space-x-12 flex w-full justify-between">
        ...
        <Link
          to="/objective"
          className="px-6 sm:px-10 md:px-16 lg:px-20 py-2 text-sm sm:text-lg md:text-xl lg:text-2xl rounded-full bg-gradient-to-r from-orange-600 to-orange-400 hover:bg-gradient-to-l focus:ring-2 focus:outline-none focus:ring-purple-200 text-white"
        >
          Selanjutnya
        </Link>
      </div>
