...
const Guide = () => {
  return (
    <section className="flex-col gap-12 bg-slate-950 min-h-screen flex items-center justify-center p-12 sm:px-6 md:px-10 lg:px-16">
      ...
      {/* Deskripsi */}
      <p className="text-sm sm:text-base md:text-lg lg:text-xl text-white text-justify max-w-xl sm:max-w-2xl md:max-w-3xl lg:max-w-4xl">
      ...
      <div className="space-x-2 sm:space-x-4 md:space-x-8 lg:space-x-12 flex w-full justify-between">
        <Link
          to="/"
          className="px-4 sm:px-6 md:px-8 lg:px-12 py-2 text-xs sm:text-sm md:text-base lg:text-lg rounded-full bg-gradient-to-r from-orange-800 to-orange-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-800 opacity-50 text-white"
        >
          Sebelumnya
        </Link>
        <Link
          to="/menu"
          className="px-4 sm:px-6 md:px-8 lg:px-12 py-2 text-xs sm:text-sm md:text-base lg:text-lg rounded-full bg-gradient-to-r from-orange-600 to-orange-400 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-800 text-white"
        >
          Selanjutnya
        </Link>
      </div>
