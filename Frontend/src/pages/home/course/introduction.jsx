...
const introduction = () => {
  return (
    <section className="flex-col gap-12 bg-slate-950 min-h-screen flex items-center justify-center p-20 px-12 sm:px-16 md:px-20 lg:px-28">
      {/* Judul */}
      ...
      <div className="space-x-2 sm:space-x-4 md:space-x-8 lg:space-x-12 flex w-full justify-between">
        <Link
          to="/course-menu"
          className="px-4 sm:px-6 md:px-8 lg:px-12 py-2 text-xs sm:text-sm md:text-base lg:text-lg rounded-full bg-gradient-to-r from-orange-800 to-orange-500 hover:bg-gradient-to-l focus:ring-2 focus:outline-none focus:ring-purple-200 opacity-50 text-white"
        >
          Sebelumnya
        </Link>
      </div>
